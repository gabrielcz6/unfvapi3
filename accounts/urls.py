...
from .views import ImageView, CursosEstudianteView,RegistrarAsistenciaView,CursoList,UsuariosMatriculadosEnCurso,AsistenciaPorCurso,EstudianteNombreView # new
...
urlpatterns = [
 ...
 path('estudiante/<str:codigo>/', EstudianteNombreView.as_view(), name='estudiante-nombre'),
 # urls.py
